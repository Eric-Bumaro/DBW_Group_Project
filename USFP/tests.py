...
def randomUser():
    ALL_ENG_NAMES = [
        ...
        , "fAddison", "mAde", "fAdelaide", "fAdele", "fAdelene", "fAdelia", "fAdelina", "fAdeline", "mAden",
        "mAdnan"
        , "mAdonis", "fAdreanna", "mAdrian", "fAdriana", "fAdrianna", "fAdrianne", "mAdriel", "fAdrienne",
        "fAerona", "fAgatha"
        ...
        , "fAlaina", "mAlan", "fAlana", "fAlanis", "fAlanna", "fAlannah", "fAlaska", "mAlastair", "fAlayah",
        "fAlayna"
        , "fAlba", "mAlbert", "fAlberta", "mAlberto", "mAlbie", "mAlden", "mAldo", "fAleah", "mAlec", "fAlecia"
        , "fAleisha", "fAlejandra", "mAlejandro", "mAlen", "fAlena", "mAlesandro", "fAlessandra", "fAlessia",
        "mAlex", "fAlex"
        ...
        , "fAllie", "fAllison", "fAlly", "fAllyson", "fAlma", "fAlondra", "mAlonzo", "mAloysius", "mAlphonso",
        "mAlton"
        , "mAlvin", "fAlycia", "fAlyshialynn", "fAlyson", "fAlyssa", "fAlyssia", "fAmalia", "fAmanda", "fAmani",
        "fAmara"
        , "mAmari", "fAmari", "fAmaris", "fAmaya", "fAmber", "fAmberly", "fAmelia", "fAmelie", "fAmerica",
        "fAmethyst"
        ...
        "fAndie"
        , "mAndre", "fAndrea", "mAndreas", "mAndres", "mAndrew", "fAndromeda", "mAndy", "mAngel", "fAngel",
        "fAngela"
        , "fAngelia", "fAngelica", "fAngelina", "fAngeline", "fAngelique", "mAngelo", "fAngie", "mAngus", "fAnika",
        "fAnisa"
        , "fAnita", "fAniya", "fAniyah", "fAnjali", "fAnn", "fAnna", "fAnnabel", "fAnnabella", "fAnnabelle",
        "fAnnabeth"
        ...
        "fAnusha"
        , "fAnushka", "fAnya", "fAoibhe", "fAoibheann", "fAoife", "fAphrodite", "mApollo", "fApple", "fApril",
        "fAqua"
        , "fArabella", "fArabelle", "mAran", "mArcher", "mArchie", "mAri", "fAria", "fAriadne", "fAriana",
        "fArianna"
        , "fArianne", "fAriel", "fAriella", "fArielle", "fArisha", "mArjun", "fArleen", "fArlene", "fArlette",
        "mArlo"
        ...
        , "mAsher", "fAshlee", "fAshleigh", "fAshley", "mAshley", "fAshlie", "fAshlyn", "fAshlynn", "mAshton",
        "fAshton"
        ...
        "mAugust"
        , "fAugustina", "mAugustus", "fAurelia", "fAurora", "mAusten", "mAustin", "fAutumn", "fAva", "fAvalon",
        "mAvery"
        , "fAvery", "fAvril", "mAxel", "fAya", "mAyaan", "fAyana", "fAyanna", "mAyden", "fAyesha", "fAyisha"
        , "fAyla", "fAzalea", "fAzaria", "fAzariah", "fBailey", "mBailey", "mBarack", "fBarbara", "fBarbie",
        "mBarclay"
        ...
        , "mBrad", "mBraden", "mBradford", "mBradley", "mBradwin", "mBrady", "mBraeden", "fBraelyn", "mBram",
        "mBranden"
        , "fBrandi", "mBrandon", "fBrandy", "mBrantley", "mBraxton", "mBrayan", "mBrayden", "mBraydon", "fBraylee",
        "mBraylon"
        , "fBrea", "fBreanna", "fBree", "fBreeze", "fBrenda", "mBrendan", "mBrenden", "mBrendon", "fBrenna",
        "mBrennan"
        ...
        "fCalypso"
        , "mCam", "fCambria", "mCamden", "mCameron", "fCameron", "fCami", "fCamila", "fCamilla", "fCamille",
        "mCampbell"
        , "mCamron", "fCamryn", "fCandace", "fCandice", "fCandis", "fCandy", "fCaoimhe", "fCaprice", "fCara",
        "mCarey"
        , "fCarina", "fCaris", "fCarissa", "mCarl", "fCarla", "fCarlene", "fCarley", "fCarlie", "mCarlisle",
        "mCarlos"
        ...
        "fChantal"
        , "fChantelle", "fCharis", "fCharissa", "fCharity", "fCharlene", "mCharles", "fCharley", "mCharley",
        "mCharlie", "fCharlie"
        , "fCharlize", "fCharlotte", "mCharlton", "fCharmaine", "mChase", "fChastity", "mChaz", "mChe", "fChelsea",
        "fChelsey"
        , "fChenai", "fChenille", "fCher", "fCheri", "fCherie", "fCherry", "fCheryl", "mChesney", "mChester",
        "mChevy"
        , "fCheyanne", "fCheyenne", "fChiara", "mChip", "fChloe", "mChris", "fChris", "fChrissy", "fChrista",
        "fChristabel"
        , "fChristal", "fChristen", "fChristi", "mChristian", "fChristiana", "fChristie", "fChristina",
        "fChristine", "mChristopher", "fChristy"
        ...
        "fClarisse"
        , "fClarity", "mClark", "fClary", "mClaude", "fClaudette", "fClaudia", "fClaudine", "mClay", "mClayton",
        "fClea"
        ...
        "fCorra"
        , "mCory", "fCosette", "fCourtney", "mCraig", "fCressida", "fCristal", "mCristian", "fCristina",
        "mCristobal", "mCrosby"
        ...
        , "mDarin", "mDario", "mDarius", "fDarla", "fDarlene", "mDarnell", "mDarragh", "mDarrel", "mDarrell",
        "mDarren"
        ...
        , "fDeena", "mDeepak", "fDeidre", "fDeirdre", "fDeja", "fDelaney", "fDelanie", "fDelany", "mDelbert",
        "fDelia"
        , "fDelilah", "fDella", "fDelores", "fDelphine", "fDemetria", "mDemetrius", "fDemi", "fDena", "mDenis",
        "fDenise"
        , "mDennis", "fDenny", "mDenver", "mDenzel", "mDeon", "mDerek", "mDermot", "mDerrick", "mDeshaun",
        "mDeshawn"
        , "fDesiree", "mDesmond", "fDestinee", "fDestiny", "mDev", "mDevin", "mDevlin", "mDevon", "mDewayne",
        "mDewey"
        ...
        , "fDixie", "mDjango", "mDmitri", "fDolly", "fDolores", "mDominic", "mDominick", "fDominique", "mDon",
        "mDonald"
        ...
        , "fElina", "fElinor", "mEliot", "fElisa", "fElisabeth", "fElise", "mElisha", "fEliza", "fElizabeth",
        "fElla"
        ...
        , "fEvangelina", "fEvangeline", "mEvangelos", "fEve", "fEvelin", "fEvelyn", "mEvelyn", "mEverett",
        "fEverly", "fEvie"
        ...
        , "fGeena", "fGemma", "fGena", "mGene", "fGenesis", "fGenevieve", "mGeoff", "mGeoffrey", "mGeorge",
        "fGeorgette"
        , "fGeorgia", "fGeorgie", "fGeorgina", "mGeraint", "mGerald", "fGeraldine", "mGerard", "mGerardo",
        "mGermain", "mGerry"
        , "fGert", "fGertrude", "fGia", "mGian", "fGianna", "mGibson", "mGideon", "fGigi", "mGil", "mGilbert"
        , "mGilberto", "mGiles", "fGillian", "fGina", "fGinger", "fGinny", "mGino", "mGiorgio", "fGiovanna",
        "mGiovanni"
        , "fGisela", "fGiselle", "fGisselle", "fGladys", "mGlen", "fGlenda", "mGlenn", "fGlenys", "fGloria",
        "mGlyndwr"
        , "fGlynis", "mGodfrey", "mGodric", "mGodwin", "fGolda", "fGoldie", "mGonzalo", "mGordon", "fGrace",
        "fGracelyn"
        , "fGracie", "mGrady", "mGraeme", "mGraham", "fGrainne", "mGrant", "mGrayson", "mGreg", "mGregg", "mGregor"
        , "mGregory", "fGreta", "fGretchen", "mGrey", "mGreyson", "mGriffin", "fGriselda", "fGuadalupe",
        "mGuillermo", "fGuinevere"
        ...
        , "mHarold", "fHarper", "fHarriet", "mHarris", "mHarrison", "mHarry", "mHarvey", "mHassan", "fHattie",
        "fHaven"
        , "mHayden", "fHayden", "mHayes", "fHaylee", "fHayley", "fHazel", "fHazeline", "mHeath", "fHeather",
        "fHeaven"
        , "mHector", "fHeidi", "fHelen", "fHelena", "fHelene", "fHelga", "fHelina", "mHendrik", "mHendrix",
        "mHenley"
        ...
        , "fIsabella", "fIsabelle", "fIsadora", "mIsaiah", "fIsha", "mIsiah", "mIsidore", "fIsis", "fIsla",
        "mIsmael"
        ...
        , "mJackson", "mJacob", "mJacoby", "fJacqueline", "fJacquelyn", "mJacques", "fJada", "fJade", "fJaden",
        "mJaden"
        ...
        , "fJania", "fJanice", "fJanie", "fJanine", "fJanis", "fJaniya", "fJanuary", "fJaqueline", "mJared",
        "mJarod"
        ...
        , "fJayla", "mJaylen", "fJaylene", "mJaylin", "fJaylinn", "mJaylon", "fJaylynn", "fJayne", "mJayson",
        "fJazlyn"
        , "fJazmin", "fJazmine", "fJazz", "fJean", "fJeanette", "fJeanine", "fJeanne", "fJeannette", "fJeannie",
        "fJeannine"
        , "mJeb", "mJebediah", "mJed", "mJediah", "mJedidiah", "mJeff", "mJefferson", "mJeffery", "mJeffrey",
        "mJeffry"
        , "fJemima", "fJemma", "fJen", "fJena", "fJenelle", "fJenessa", "fJenna", "fJennette", "fJenni", "fJennie"
        , "fJennifer", "fJenny", "fJensen", "mJensen", "mJenson", "mJerald", "mJeremiah", "mJeremy", "fJeri",
        "mJericho"
        ...
        , "mJohnathan", "mJohnathon", "mJohnnie", "mJohnny", "fJoleen", "fJolene", "fJolie", "mJon", "mJonah",
        "mJonas"
        , "mJonathan", "mJonathon", "fJoni", "mJonty", "mJordan", "fJordan", "fJordana", "mJordon", "mJordy",
        "fJordyn"
        ...
        , "fJulienne", "fJuliet", "fJuliette", "mJulio", "fJulissa", "mJulius", "fJuly", "fJune", "fJuniper",
        "fJuno"
        , "fJustice", "mJustice", "mJustin", "fJustina", "fJustine", "fKacey", "mKade", "mKaden", "fKadence", "mKai"
        , "mKaiden", "fKaidence", "fKailey", "fKailyn", "mKaine", "fKaitlin", "fKaitlyn", "fKaitlynn", "mKale",
        "fKalea"
        ...
        , "fKarolina", "mKarson", "fKaryn", "fKasey", "mKash", "mKasper", "fKassandra", "fKassidy", "fKassie",
        "fKat"
        ...
        , "mKayden", "fKaye", "fKayla", "fKaylee", "fKayleigh", "mKaylen", "fKayley", "fKaylie", "fKaylin",
        "mKayson"
        ...
        , "fKelsey", "fKelsie", "mKelvin", "mKen", "fKendall", "mKendall", "fKendra", "mKendrick", "fKenna",
        "fKennedy"
        ...
        , "fKori", "fKourtney", "mKris", "fKris", "mKrish", "fKrista", "fKristen", "fKristi", "mKristian",
        "fKristie"
        , "fKristin", "fKristina", "fKristine", "mKristoff", "mKristopher", "fKristy", "fKrystal", "mKurt",
        "mKurtis", "mKye"
        ...
        , "fMacey", "fMacie", "mMack", "fMackenzie", "fMacy", "fMadalyn", "fMaddie", "fMaddison", "mMaddox",
        "fMaddy"
        ...
        "fMariella"
        , "mMarik", "fMarilyn", "fMarina", "mMario", "mMarion", "fMarion", "fMarisa", "fMarisol", "fMarissa",
        "fMaritza"
        , "fMarjorie", "mMark", "fMarla", "fMarlee", "fMarlena", "fMarlene", "mMarley", "fMarley", "mMarlon",
        "fMarnie"
        , "mMarquis", "fMarsha", "mMarshall", "fMartha", "mMartin", "fMartina", "mMarty", "mMartyn", "mMarvin",
        "fMary"
        , "fMaryam", "fMaryann", "fMarybeth", "fMasie", "mMason", "mMassimo", "mMat", "mMateo", "mMathew",
        "fMatilda"
        ...
        , "mMoises", "fMollie", "fMolly", "fMona", "fMonica", "fMonika", "fMonique", "fMontana", "mMonte",
        "fMontserrat"
        , "mMonty", "mMordecai", "mMorgan", "fMorgan", "fMorgana", "mMorris", "mMoses", "fMoya", "mMuhammad",
        "fMuriel"
        ...
        , "mNasir", "fNatalia", "fNatalie", "fNatasha", "mNate", "mNath", "mNathan", "mNathanael", "mNathaniel",
        "fNaya"
        ...
        , "fNicola", "mNicolas", "fNicole", "fNicolette", "fNieve", "mNigel", "fNiki", "fNikita", "fNikki",
        "mNiklaus"
        ...
        , "mParker", "mPascal", "mPat", "fPatience", "fPatrice", "fPatricia", "mPatrick", "fPatsy", "fPatti",
        "fPatty"
        , "mPaul", "fPaula", "fPaulette", "fPaulina", "fPauline", "mPaxton", "fPayton", "mPayton", "fPeace",
        "mPearce"
        , "fPearl", "mPedro", "fPeggy", "fPenelope", "fPenny", "mPercy", "fPerla", "fPerrie", "mPerry",
        "fPersephone"
        , "mPetar", "mPete", "mPeter", "fPetra", "fPetunia", "fPeyton", "mPeyton", "mPhebian", "mPhil", "mPhilip"
        , "mPhilippe", "mPhillip", "fPhillipa", "fPhilomena", "mPhineas", "fPhoebe", "fPhoenix", "mPhoenix",
        "fPhyllis", "mPierce"
        ...
        "mQuinlan"
        , "fQuinn", "mQuinn", "mQuinton", "mQuintrell", "fRabia", "fRachael", "fRachel", "fRachelle", "fRae",
        "fRaegan"
        ...
        , "fRochelle", "fRocio", "mRock", "mRocky", "mRod", "mRoderick", "mRodger", "mRodney", "mRodolfo",
        "mRodrigo"
        ...
        , "fRosalina", "fRosalind", "fRosalinda", "fRosalynn", "fRosanna", "mRoscoe", "fRose", "fRoseanne",
        "fRosella", "fRosemarie"
        ...
        , "mSammy", "mSamson", "mSamuel", "mSandeep", "fSandra", "fSandy", "mSandy", "fSania", "mSanjay",
        "mSantiago"
        , "fSaoirse", "fSapphire", "fSara", "fSarah", "fSarina", "fSariya", "fSascha", "fSasha", "mSasha", "fSaskia"
        , "mSaul", "fSavanna", "fSavannah", "mSawyer", "fScarlet", "fScarlett", "mScot", "mScott", "mScottie",
        "mScotty"
        ...
        , "mShea", "fSheba", "fSheena", "fSheila", "fShelby", "mSheldon", "fShelia", "fShelley", "fShelly",
        "mShelton"
        ...
        , "fSierra", "fSigourney", "mSilas", "fSilvia", "mSimeon", "mSimon", "fSimone", "fSimran", "fSinead",
        "fSiobhan"
        ...
        , "fSusannah", "fSusanne", "fSusie", "fSutton", "fSuzanna", "fSuzanne", "fSuzette", "fSuzie", "fSuzy",
        "mSven"
        , "fSybil", "fSydney", "mSylvester", "fSylvia", "fSylvie", "fTabatha", "fTabitha", "mTadhg", "fTahlia",
        "fTala"
        ...
        "fTheresa"
        , "fTherese", "mThomas", "fThomasina", "mThor", "fTia", "mTiago", "fTiana", "mTiberius", "fTiegan",
        "fTiffany"
        ...
        , "fTricia", "fTrina", "fTrinity", "fTrish", "fTrisha", "fTrista", "mTristan", "mTristen", "mTriston",
        "fTrixie"
        ...
        , "fUrsula", "mUsama", "mValentin", "fValentina", "mValentine", "mValentino", "fValeria", "fValerie",
        "fValery", "mVan"
        , "mVance", "fVanessa", "mVasco", "mVaughn", "fVeda", "fVelma", "fVenetia", "fVenus", "fVera", "fVerity"
        , "mVernon", "fVeronica", "fVicki", "fVickie", "fVicky", "mVictor", "fVictoria", "fVienna", "mVihan",
        "mVijay"
        , "mVikram", "mVince", "mVincent", "mVinnie", "fViola", "fViolet", "fVioletta", "mVirgil", "fVirginia",
        "mVishal"
        , "fVivian", "mVivian", "fViviana", "fVivien", "fVivienne", "mVlad", "mVladimir", "mWade", "mWalker",
        "mWallace"
        , "fWallis", "mWalter", "fWanda", "mWarren", "fWaverley", "mWaylon", "mWayne", "mWendell", "fWendi",
        "fWendy"
        ...
        , "mZach", "mZachariah", "mZachary", "mZachery", "mZack", "mZackary", "mZackery", "fZada", "fZaheera",
        "fZahra"
    ...
    for i in range(0, 400):
        ...
        mailList = ["p930026130@mail.uic.edu.cn", "2161217535@qq.com"]
